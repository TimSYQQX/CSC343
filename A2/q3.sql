...
select name, p1.country_id, p1.year, p1.participationRatio, p2.country_id as country_id2, p2.year as year2, p2.participationRatio as p
from participationRatio_in_period p1,participationRatio_in_period p2, country
where p1.country_id = p2.country_id and p1.year > p2.year and p1.participationRatio >= p2.participationRatio AND p1.country_id = id;
